    ...
    return (
        ...
        <div className={styles.footer}> 
            ...
            <button 
                ...
                disabled={!canPreviousPage}><span className={styles.footerBtnPrevArrow}><NextArrow /></span>Попередня</button>
            <button 
                className={styles.footerBtn}
                onClick={() => nextPage()}
                disabled={!canNextPage}>Наступна <span className={styles.footerBtnNextArrow}><NextArrow /></span></button>
        </div>
        </>
    )
}
